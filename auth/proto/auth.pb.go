...
const file_auth_proto_auth_proto_rawDesc = "" +
	"\n" +
	"\x15auth/proto/auth.proto\x12\x04auth\"W\n" +
	...
	"\rValidateToken\x12\x15.auth.ValidateRequest\x1a\x16.auth.ValidateResponseB\x15Z\x13services/auth/protob\x06proto3"
