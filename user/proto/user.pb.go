...
const file_user_proto_user_proto_rawDesc = "" +
	...
	"\tListUsers\x12\v.user.Empty\x1a\x16.user.UserListResponse\x12?\n" +
	"\n" +
	"DeleteUser\x12\x17.user.DeleteUserRequest\x1a\x18.user.DeleteUserResponseB\x15Z\x13services/user/protob\x06proto3"
...
var file_user_proto_user_proto_depIdxs = []int32{
	...
	5, // 2: user.UserService.ListUsers:input_type -> user.Empty
	...
	2, // 5: user.UserService.ListUsers:output_type -> user.UserListResponse
